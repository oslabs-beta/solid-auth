...
import { isServer, getRequestEvent, renderToString, ssrElement, escape, mergeProps, ssr, renderToStream, createComponent as createComponent$1, ssrHydrationKey, NoHydration, useAssets, HydrationScript, ssrAttribute, Hydration } from 'solid-js/web';
import { provideRequestEvent } from 'solid-js/web/storage';
import { createContext as createContext$1, createSignal, getOwner, onCleanup, getListener, startTransition, sharedConfig, createMemo, $TRACK, useContext, lazy, createComponent, ErrorBoundary, catchError } from 'solid-js';
...
class SHA256 extends Hasher {
  ...
  _doProcessBlock(M, offset) {
    ...
    for (let i = 0; i < 64; i++) {
      ...
      const t1 = h + sigma1 + ch + K$2[i] + W[i];
      const t2 = sigma0 + maj;
      h = g;
      g = f;
      f = e;
...
storage.mount('data', pe$2({"driver":"fsLite","base":"/home/ssmoss/Desktop/solid-auth/test-folder/.data/kv"}));
...
const appConfig = {"name":"vinxi","routers":[{"name":"public","type":"static","base":"/","dir":"./public","root":"/home/ssmoss/Desktop/solid-auth/test-folder","order":0,"outDir":"/home/ssmoss/Desktop/solid-auth/test-folder/.vinxi/build/public"},{"name":"ssr","type":"http","link":{"client":"client"},"handler":"lib/entry-server.tsx","extensions":["js","jsx","ts","tsx"],"target":"server","root":"/home/ssmoss/Desktop/solid-auth/test-folder","base":"/","outDir":"/home/ssmoss/Desktop/solid-auth/test-folder/.vinxi/build/ssr","order":1},{"name":"client","type":"client","base":"/_build","handler":"lib/entry-client.tsx","extensions":["js","jsx","ts","tsx"],"target":"browser","root":"/home/ssmoss/Desktop/solid-auth/test-folder","outDir":"/home/ssmoss/Desktop/solid-auth/test-folder/.vinxi/build/client","order":2},{"name":"server-fns","type":"http","base":"/_server","handler":"node_modules/@solidjs/start/dist/runtime/server-handler.js","target":"server","root":"/home/ssmoss/Desktop/solid-auth/test-folder","outDir":"/home/ssmoss/Desktop/solid-auth/test-folder/.vinxi/build/server-fns","order":3}],"server":{"compressPublicAssets":{"brotli":true},"routeRules":{"/_build/assets/**":{"headers":{"cache-control":"public, immutable, max-age=31536000"}}},"experimental":{"asyncContext":true}},"root":"/home/ssmoss/Desktop/solid-auth/test-folder"};
				const buildManifest = {"ssr":{"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/auth-logo.png":{"file":"assets/auth-logo-Bwvg09ZW.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/auth-logo.png"},"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/google.png":{"file":"assets/google-Bp_336oh.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/google.png"},"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/hide.png":{"file":"assets/hide-CcLQG700.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/hide.png"},"_index-DbjfwbOx.js":{"file":"assets/index-DbjfwbOx.js","name":"index"},"src/routes/[...404].tsx?pick=default&pick=$css":{"file":"_...404_.js","name":"_...404_","src":"src/routes/[...404].tsx?pick=default&pick=$css","isEntry":true,"isDynamicEntry":true},"src/routes/index.tsx?pick=default&pick=$css":{"file":"index.js","name":"index","src":"src/routes/index.tsx?pick=default&pick=$css","isEntry":true,"isDynamicEntry":true,"imports":["_index-DbjfwbOx.js"]},"src/routes/login.tsx?pick=default&pick=$css":{"file":"login.js","name":"login","src":"src/routes/login.tsx?pick=default&pick=$css","isEntry":true,"isDynamicEntry":true,"imports":["_index-DbjfwbOx.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_index-DbjfwbOx.js"],"dynamicImports":["src/routes/[...404].tsx?pick=default&pick=$css","src/routes/[...404].tsx?pick=default&pick=$css","src/routes/index.tsx?pick=default&pick=$css","src/routes/index.tsx?pick=default&pick=$css","src/routes/login.tsx?pick=default&pick=$css","src/routes/login.tsx?pick=default&pick=$css"],"css":["assets/ssr-BYLN711c.css"],"assets":["assets/auth-logo-Bwvg09ZW.png","assets/google-Bp_336oh.png","assets/hide-CcLQG700.png"]}},"client":{"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/auth-logo.png":{"file":"assets/auth-logo-Bwvg09ZW.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/auth-logo.png"},"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/google.png":{"file":"assets/google-Bp_336oh.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/google.png"},"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/hide.png":{"file":"assets/hide-CcLQG700.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/hide.png"},"_index-BSgOKi0E.js":{"file":"assets/index-BSgOKi0E.js","name":"index","imports":["_web-BZwEqE-T.js"]},"_web-BZwEqE-T.js":{"file":"assets/web-BZwEqE-T.js","name":"web"},"src/routes/[...404].tsx?pick=default&pick=$css":{"file":"assets/_...404_-DfwnSqRb.js","name":"_...404_","src":"src/routes/[...404].tsx?pick=default&pick=$css","isEntry":true,"imports":["_web-BZwEqE-T.js"]},"src/routes/index.tsx?pick=default&pick=$css":{"file":"assets/index-DYNFtd-j.js","name":"index","src":"src/routes/index.tsx?pick=default&pick=$css","isEntry":true,"imports":["_web-BZwEqE-T.js","_index-BSgOKi0E.js"]},"src/routes/login.tsx?pick=default&pick=$css":{"file":"assets/login-BYDnqFuM.js","name":"login","src":"src/routes/login.tsx?pick=default&pick=$css","isEntry":true,"imports":["_web-BZwEqE-T.js","_index-BSgOKi0E.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-Ci-0MQDq.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_web-BZwEqE-T.js"],"css":["assets/client-BYLN711c.css"],"assets":["assets/auth-logo-Bwvg09ZW.png","assets/google-Bp_336oh.png","assets/hide-CcLQG700.png"]}},"server-fns":{"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/auth-logo.png":{"file":"assets/auth-logo-Bwvg09ZW.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/auth-logo.png"},"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/google.png":{"file":"assets/google-Bp_336oh.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/google.png"},"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/hide.png":{"file":"assets/hide-CcLQG700.png","src":"../packages/solidstart-auth-backend-v3/src/components/LoginForm/images/hide.png"},"_index2.mjs":{"file":"index2.mjs","name":"index"},"src/app.tsx":{"file":"app.mjs","name":"app","src":"src/app.tsx","isDynamicEntry":true,"css":["assets/app-BYLN711c.css"],"assets":["assets/auth-logo-Bwvg09ZW.png","assets/google-Bp_336oh.png","assets/hide-CcLQG700.png"]},"src/lib/index.ts":{"file":"c_5810.mjs","name":"c_5810","src":"src/lib/index.ts","isEntry":true,"imports":["_index2.mjs"]},"src/routes/[...404].tsx?pick=default&pick=$css":{"file":"_...404_.mjs","name":"_...404_","src":"src/routes/[...404].tsx?pick=default&pick=$css","isDynamicEntry":true},"src/routes/index.tsx?pick=default&pick=$css":{"file":"index.mjs","name":"index","src":"src/routes/index.tsx?pick=default&pick=$css","isDynamicEntry":true,"imports":["_index2.mjs"]},"src/routes/login.tsx?pick=default&pick=$css":{"file":"login.mjs","name":"login","src":"src/routes/login.tsx?pick=default&pick=$css","isDynamicEntry":true,"imports":["_index2.mjs"]},"virtual:$vinxi/handler/server-fns":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server-fns","isEntry":true,"imports":["_index2.mjs"],"dynamicImports":["src/routes/[...404].tsx?pick=default&pick=$css","src/routes/[...404].tsx?pick=default&pick=$css","src/routes/index.tsx?pick=default&pick=$css","src/routes/index.tsx?pick=default&pick=$css","src/routes/login.tsx?pick=default&pick=$css","src/routes/login.tsx?pick=default&pick=$css","src/app.tsx"]}}};
...
function Se$2(e){let t;const n=N$2(e),r={duplex:"half",method:e.method,headers:e.headers};return e.node.req.body instanceof ArrayBuffer?new Request(n,{...r,body:e.node.req.body}):new Request(n,{...r,get body(){return t||(t=Ae$2(e),t)}})}function ve$2(e){return e.web??={request:Se$2(e),url:N$2(e)},e.web.request}function be$2(){return Ue$2()}const D$1=Symbol("$HTTPEvent");function Ee$2(e){return typeof e=="object"&&(e instanceof H3Event||e?.[D$1]instanceof H3Event||e?.__is_event__===!0)}function d(e){return function(...t){let n=t[0];if(Ee$2(n))t[0]=n instanceof H3Event||n.__is_event__?n:n[D$1];else {if(!globalThis.app.config.server.experimental?.asyncContext)throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");if(n=be$2(),!n)throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");t.unshift(n);}return e(...t)}}const N$2=d(getRequestURL),$e$2=d(getRequestIP),L$2=d(setResponseStatus),k$2=d(getResponseStatus),xe$2=d(getResponseStatusText),$$1=d(getResponseHeaders),j$1=d(getResponseHeader),Ce$2=d(setResponseHeader),K$1=d(appendResponseHeader),ft=d(getCookie),lt$1=d(setCookie),He$2=d(useSession),gt$1=d(setHeader),Ae$2=d(getRequestWebStream),Te$2=d(removeResponseHeader),Oe$2=d(ve$2);function qe$2(){return getContext("nitro-app",{asyncContext:!!globalThis.app.config.server.experimental?.asyncContext,AsyncLocalStorage:AsyncLocalStorage})}function Ue$2(){return qe$2().use().event}const T$1=Symbol("fetchEvent");function Ie$2(e){return {request:Oe$2(e),response:Le$3(e),clientAddress:$e$2(e),locals:{},nativeEvent:e}}function _e$2(e){return {...e}}function ht$1(e){if(!e[T$1]){const t=Ie$2(e);e[T$1]=t;}return e[T$1]}function pt$1(e,t){for(const[n,r]of t.entries())K$1(e,n,r);}let Pe$2 = class Pe{event;constructor(t){this.event=t;}get(t){const n=j$1(this.event,t);return Array.isArray(n)?n.join(", "):n||null}has(t){return this.get(t)!==void 0}set(t,n){return Ce$2(this.event,t,n)}delete(t){return Te$2(this.event,t)}append(t,n){K$1(this.event,t,n);}getSetCookie(){const t=j$1(this.event,"Set-Cookie");return Array.isArray(t)?t:[t]}forEach(t){return Object.entries($$1(this.event)).forEach(([n,r])=>t(Array.isArray(r)?r.join(", "):r,n,this))}entries(){return Object.entries($$1(this.event)).map(([t,n])=>[t,Array.isArray(n)?n.join(", "):n])[Symbol.iterator]()}keys(){return Object.keys($$1(this.event))[Symbol.iterator]()}values(){return Object.values($$1(this.event)).map(t=>Array.isArray(t)?t.join(", "):t)[Symbol.iterator]()}[Symbol.iterator](){return this.entries()[Symbol.iterator]()}};function Le$3(e){return {get status(){return k$2(e)},set status(t){L$2(e,t);},get statusText(){return xe$2(e)},set statusText(t){L$2(e,k$2(e),t);},headers:new Pe$2(e)}}function H$1(e,t,n){if(typeof e!="function")throw new Error("Export from a 'use server' module must be a function");const r="";return new Proxy(e,{get(s,o,c){return o==="url"?`${r}/_server?id=${encodeURIComponent(t)}&name=${encodeURIComponent(n)}`:o==="GET"?c:s[o]},apply(s,o,c){const u=getRequestEvent();if(!u)throw new Error("Cannot call server function outside of a request");const f=_e$2(u);return f.locals.serverFunctionMeta={id:t+"#"+n},f.serverOnly=!0,provideRequestEvent(f,()=>e.apply(o,c))}})}const ke$2="http://sr";function je$1(e,t){if(e==null)throw new Error(t);return e}const Fe$1=createContext$1();createContext$1();const X$1=()=>je$1(useContext(Fe$1),"<A> and 'use' router primitives can be only used inside a Route."),We$1=()=>X$1().navigatorFactory();let Me$2;function Be$2(){return Me$2}const De$2="Location",Ne$2=5e3,Ke$1=18e4;let b$2=new Map;isServer||setInterval(()=>{const e=Date.now();for(let[t,n]of b$2.entries())!n[3].count&&e-n[0]>Ke$1&&b$2.delete(t);},3e5);function I$2(){if(!isServer)return b$2;const e=getRequestEvent();if(!e)throw new Error("Cannot find cache context");return (e.router||(e.router={})).cache||(e.router.cache=new Map)}function Xe$1(e,t=!0){return startTransition(()=>{const n=Date.now();G$1(e,r=>{t&&(r[0]=0),r[3][1](n);});})}function G$1(e,t){e&&!Array.isArray(e)&&(e=[e]);for(let n of b$2.keys())(e===void 0||Ge$2(n,e))&&t(b$2.get(n));}function A$1(e,t){e.GET&&(e=e.GET);const n=(...r)=>{const s=I$2(),o=Be$2(),u=getOwner()?We$1():void 0,f=Date.now(),g=t+q$1(r);let a=s.get(g),m;if(isServer){const i=getRequestEvent();if(i){const y=(i.router||(i.router={})).dataOnly;if(y){const w=i&&(i.router.data||(i.router.data={}));if(w&&g in w)return w[g];if(Array.isArray(y)&&!y.includes(g))return w[g]=void 0,Promise.resolve()}}}if(getListener()&&!isServer&&(m=!0,onCleanup(()=>a[3].count--)),a&&a[0]&&(isServer||o==="native"||a[3].count||Date.now()-a[0]<Ne$2)){m&&(a[3].count++,a[3][0]()),a[2]==="preload"&&o!=="preload"&&(a[0]=f);let i=a[1];return i="then"in a[1]?a[1].then(p(!1),p(!0)):p(!1)(a[1]),!isServer&&o==="navigate"&&startTransition(()=>a[3][1](a[0])),i}let h=!isServer&&sharedConfig.context&&sharedConfig.has(g)?sharedConfig.load(g):e(...r);if(a?(a[0]=f,a[1]=h,a[2]=o,!isServer&&o==="navigate"&&startTransition(()=>a[3][1](a[0]))):(s.set(g,a=[f,h,o,createSignal(f)]),a[3].count=0),m&&(a[3].count++,a[3][0]()),isServer){const i=getRequestEvent();if(i&&i.router.dataOnly)return i.router.data[g]=h}if(h="then"in h?h.then(p(!1),p(!0)):p(!1)(h),isServer&&sharedConfig.context&&sharedConfig.context.async&&!sharedConfig.context.noHydrate){const i=getRequestEvent();(!i||!i.serverOnly)&&sharedConfig.context.serialize(g,h);}return h;function p(i){return async y=>{if(y instanceof Response){const w=y.headers.get(De$2);if(w!==null){if(u&&w.startsWith("/"))startTransition(()=>{u(w,{replace:!0});});else if(!isServer)window.location.href=w;else if(isServer){const P=getRequestEvent();P&&(P.response={status:302,headers:new Headers({Location:w})});}return}y.customBody&&(y=await y.customBody());}if(i)throw y;return y}}};return n.keyFor=(...r)=>t+q$1(r),n.key=t,n}A$1.set=(e,t)=>{const n=I$2(),r=Date.now();let s=n.get(e);s?(s[0]=r,s[1]=t,s[2]="preload"):(n.set(e,s=[r,t,,createSignal(r)]),s[3].count=0);};A$1.clear=()=>I$2().clear();function Ge$2(e,t){for(let n of t)if(e.startsWith(n))return !0;return !1}function q$1(e){return JSON.stringify(e,(t,n)=>ze$2(n)?Object.keys(n).sort().reduce((r,s)=>(r[s]=n[s],r),{}):n)}function ze$2(e){let t;return e!=null&&typeof e=="object"&&(!(t=Object.getPrototypeOf(e))||t===Object.prototype)}const F$1=new Map;function Je$1(e,t){const n=X$1(),r=createMemo(()=>n.submissions[0]().filter(s=>s.url===e.toString()&&!t));return new Proxy([],{get(s,o){return o===$TRACK?r():o==="pending"?r().some(c=>!c.result):r()[o]}})}function yt$1(e,t){const n=Je$1(e,t);return new Proxy({},{get(r,s){return n.length===0&&s==="clear"||s==="retry"?()=>{}:n[n.length-1]?.[s]}})}function z$1(e,t){function n(...s){const o=this.r,c=this.f,u=(o.singleFlight&&e.withOptions?e.withOptions({headers:{"X-Single-Flight":"true"}}):e)(...s),[f,g]=createSignal();let a;function m(h){return async p=>{const i=await Ve$1(p,h,o.navigatorFactory());if(!i)return a.clear();if(g(i),i.error&&!c)throw i.error;return i.data}}return o.submissions[1](h=>[...h,a={input:s,url:r,get result(){return f()?.data},get error(){return f()?.error},get pending(){return !f()},clear(){o.submissions[1](p=>p.filter(i=>i.input!==s));},retry(){return g(void 0),e(...s).then(m(),m(!0))}}]),u.then(m(),m(!0))}const r=e.url||t||(isServer?"":`https://action/${Qe$1(e.toString())}`);return J(n,r)}function J(e,t){return e.toString=()=>{if(!t)throw new Error("Client Actions need explicit names if server rendered");return t},e.with=function(...n){const r=function(...o){return e.call(this,...n,...o)},s=new URL(t,ke$2);return s.searchParams.set("args",q$1(n)),J(r,(s.origin==="https://action"?s.origin:"")+s.pathname+s.search)},e.url=t,isServer||(F$1.set(t,e),getOwner()&&onCleanup(()=>F$1.delete(t))),e}const Qe$1=e=>e.split("").reduce((t,n)=>(t<<5)-t+n.charCodeAt(0)|0,0);async function Ve$1(e,t,n){let r,s,o,c;if(e instanceof Response){if(e.headers.has("X-Revalidate")&&(o=e.headers.get("X-Revalidate").split(",")),e.customBody&&(r=s=await e.customBody(),e.headers.has("X-Single-Flight")&&(r=r._$value,delete s._$value,c=Object.keys(s))),e.headers.has("Location")){const u=e.headers.get("Location")||"/";u.startsWith("http")?window.location.href=u:n(u);}}else {if(t)return {error:e};r=e;}return G$1(o,u=>u[0]=0),c&&c.forEach(u=>A$1.set(u,s[u])),await Xe$1(o,!1),r!=null?{data:r}:void 0}function _$1(e,t=302){let n,r;typeof t=="number"?n={status:t}:({revalidate:r,...n}=t,typeof n.status>"u"&&(n.status=302));const s=new Headers(n.headers);return s.set("Location",e),r&&s.set("X-Revalidate",r.toString()),new Response(null,{...n,headers:s})}const v$1=createStorage({driver:pe$2({base:"./.data"})});v$1.setItem("users:data",[{id:0,username:"kody",password:"twixrox"}]);v$1.setItem("users:counter",1);const C$2={user:{async create({data:e}){const[{value:t},{value:n}]=await v$1.getItems(["users:data","users:counter"]),r={...e,id:n};return await Promise.all([v$1.setItem("users:data",[...t,r]),v$1.setItem("users:counter",n+1)]),r},async findUnique({where:{username:e=void 0,id:t=void 0}}){const n=await v$1.getItem("users:data");return t!==void 0?n.find(r=>r.id===t):n.find(r=>r.username===e)}}},E$1={getSession:async()=>{const e=await He$2({password:process.env.SESSION_SECRET??"areallylongsecretthatyoushouldreplace"});return {...e,update:async t=>{const n={...e.data};t(n),await e.update(r=>({...r,...n}));}}},login:async(e,t)=>{const n=await C$2.user.findUnique({where:{username:e}});if(!n||t!==n.password)throw new Error("Invalid login");return {...n,id:n.id}},register:async(e,t)=>{if(await C$2.user.findUnique({where:{username:e}}))throw new Error("User already exists");return C$2.user.create({data:{username:e,password:t}})},logout:async()=>{const e=await E$1.getSession();e?.data.userId&&await e.update(t=>{t.userId=void 0;});},validateUsername:e=>{if(typeof e!="string"||e.length<3)return "Usernames must be at least 3 characters long"},validatePassword:e=>{if(typeof e!="string"||e.length<6)return "Passwords must be at least 6 characters long"}},wt$1=A$1(H$1(Ze$1,"c_5810","$$function0"),"user"),mt$1=z$1(H$1(et$1,"c_5810","$$function1")),Ye$1=H$1(tt$2,"c_5810","$$function2"),Rt$1=z$1(H$1(nt$1,"c_5810","$$function3"));async function Ze$1(){try{const e=await E$1.getSession(),t=Number(e.data.userId);if(t===void 0)throw new Error("User not found");const n=await C$2.user.findUnique({where:{id:t}});if(!n)throw new Error("User not found");return {id:n.id,username:n.username}}catch{await E$1.logout(),_$1("/login");}}async function et$1(e){return Ye$1(e,E$1)}async function tt$2(e,t){const n=String(e.get("username")),r=String(e.get("password")),s=String(e.get("loginType"));let o=t.validateUsername(n)||t.validatePassword(r);if(o)return new Error(o);try{const c=await(s!=="login"?t.register(n,r):t.login(n,r));await(await t.getSession()).update(f=>{f.userId=c.id.toString();});}catch(c){return c}return _$1("/")}async function nt$1(){return await E$1.logout(),_$1("/login")}
...
const mod_0_3 = /*#__PURE__*/Object.freeze({
	...
	$$function3: nt$1,
	getUser: wt$1,
	loginOrRegister: mt$1,
	logout: Rt$1
});

const chunks = {};
				chunks['c_5810.mjs'] = mod_0_3;
...
const assets = {
  "/_build/server-functions-manifest.json": {
    ...
    "etag": "\"57-vLUrK9A1MrleOaYB+pg62VC0yaQ\"",
    "mtime": "2024-09-14T08:39:43.374Z",
    "size": 87,
    "path": "../public/_build/server-functions-manifest.json"
  },
  "/assets/auth-logo-Bwvg09ZW.png": {
    "type": "image/png",
    "etag": "\"4834-oMPK90UmB6bkEqljYCIXVqNTIbE\"",
    "mtime": "2024-09-14T08:39:43.367Z",
    "size": 18484,
    "path": "../public/assets/auth-logo-Bwvg09ZW.png"
  },
  "/assets/google-Bp_336oh.png": {
    "type": "image/png",
    "etag": "\"5181-jkJBOZuu++j4/v+rD+Z2guFA4bE\"",
    "mtime": "2024-09-14T08:39:43.368Z",
    "size": 20865,
    "path": "../public/assets/google-Bp_336oh.png"
  },
  "/assets/hide-CcLQG700.png": {
    "type": "image/png",
    "etag": "\"397a-mvu2owgxW3w1RKvsEO/Fk0iRo/s\"",
    "mtime": "2024-09-14T08:39:43.368Z",
    "size": 14714,
    "path": "../public/assets/hide-CcLQG700.png"
  },
  "/assets/index-DbjfwbOx.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2ac4-NaeEir+rdypv9Rglxxmfv18Zg8Q\"",
    "mtime": "2024-09-14T08:39:43.368Z",
    "size": 10948,
    "path": "../public/assets/index-DbjfwbOx.js"
  },
  "/assets/index-DbjfwbOx.js.br": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "br",
    "etag": "\"1008-J7DIWjJR99qtZLRjBJzqsziEW8E\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 4104,
    "path": "../public/assets/index-DbjfwbOx.js.br"
  },
  "/assets/index-DbjfwbOx.js.gz": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"11c1-YU3I2WCuBbqkC9nYW0Jf5VpdVGQ\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 4545,
    "path": "../public/assets/index-DbjfwbOx.js.gz"
  },
  "/assets/ssr-BYLN711c.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"e5b-MioCm5vPIX1A6a1DaceofOgm7QA\"",
    "mtime": "2024-09-14T08:39:43.368Z",
    "size": 3675,
    "path": "../public/assets/ssr-BYLN711c.css"
  },
  "/assets/ssr-BYLN711c.css.br": {
    "type": "text/css; charset=utf-8",
    "encoding": "br",
    "etag": "\"3d2-6ljG95ewl4x6McF+WaFReie1IZU\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 978,
    "path": "../public/assets/ssr-BYLN711c.css.br"
  },
  "/assets/ssr-BYLN711c.css.gz": {
    "type": "text/css; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"4a7-Pn/kL+fdBVqzud9Ep9FGX2esVeE\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 1191,
    "path": "../public/assets/ssr-BYLN711c.css.gz"
  },
  "/_build/.vite/manifest.json": {
    "type": "application/json",
    "etag": "\"84f-ElZM+VtdxXCuewq/sC2oeuv655E\"",
    "mtime": "2024-09-14T08:39:43.375Z",
    "size": 2127,
  ...
  "/_build/.vite/manifest.json.br": {
    "type": "application/json",
    "encoding": "br",
    "etag": "\"1a2-veDHXoNZNCT2Zx5KwA7a1dsbGIA\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 418,
  ...
  "/_build/.vite/manifest.json.gz": {
    "type": "application/json",
    "encoding": "gzip",
    "etag": "\"1ec-LULBbffDz64cQdLB6cCbPe3GxqM\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 492,
    "path": "../public/_build/.vite/manifest.json.gz"
  },
  "/_build/assets/_...404_-DfwnSqRb.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"b7-Skb1iu1HG0xzZSNo/ExE4Q/MVEM\"",
    "mtime": "2024-09-14T08:39:43.375Z",
    "size": 183,
    "path": "../public/_build/assets/_...404_-DfwnSqRb.js"
  },
  "/_build/assets/auth-logo-Bwvg09ZW.png": {
    "type": "image/png",
    "etag": "\"4834-oMPK90UmB6bkEqljYCIXVqNTIbE\"",
    "mtime": "2024-09-14T08:39:43.375Z",
    "size": 18484,
    "path": "../public/_build/assets/auth-logo-Bwvg09ZW.png"
  },
  "/_build/assets/client-BYLN711c.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"e5b-MioCm5vPIX1A6a1DaceofOgm7QA\"",
    "mtime": "2024-09-14T08:39:43.375Z",
    "size": 3675,
    "path": "../public/_build/assets/client-BYLN711c.css"
  },
  "/_build/assets/client-BYLN711c.css.br": {
    "type": "text/css; charset=utf-8",
    "encoding": "br",
    "etag": "\"3d2-6ljG95ewl4x6McF+WaFReie1IZU\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 978,
    "path": "../public/_build/assets/client-BYLN711c.css.br"
  },
  "/_build/assets/client-BYLN711c.css.gz": {
    "type": "text/css; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"4a7-Pn/kL+fdBVqzud9Ep9FGX2esVeE\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 1191,
    "path": "../public/_build/assets/client-BYLN711c.css.gz"
  },
  "/_build/assets/client-Ci-0MQDq.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"316f-ggZ+Q/YoHM1/7x8n3rwq8kLY8XA\"",
    "mtime": "2024-09-14T08:39:43.376Z",
    "size": 12655,
    "path": "../public/_build/assets/client-Ci-0MQDq.js"
  },
  "/_build/assets/client-Ci-0MQDq.js.br": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "br",
    "etag": "\"12ab-fnb4+xji1tjUtFSlZNH+J5XEIwE\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 4779,
    "path": "../public/_build/assets/client-Ci-0MQDq.js.br"
  },
  "/_build/assets/client-Ci-0MQDq.js.gz": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"1511-4CzS09drkdWJ3t2Jt8rmu2v6Zv8\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 5393,
    "path": "../public/_build/assets/client-Ci-0MQDq.js.gz"
  },
  "/_build/assets/google-Bp_336oh.png": {
    "type": "image/png",
    "etag": "\"5181-jkJBOZuu++j4/v+rD+Z2guFA4bE\"",
    "mtime": "2024-09-14T08:39:43.376Z",
    "size": 20865,
    "path": "../public/_build/assets/google-Bp_336oh.png"
  },
  "/_build/assets/hide-CcLQG700.png": {
    "type": "image/png",
    "etag": "\"397a-mvu2owgxW3w1RKvsEO/Fk0iRo/s\"",
    "mtime": "2024-09-14T08:39:43.376Z",
    "size": 14714,
    "path": "../public/_build/assets/hide-CcLQG700.png"
  },
  "/_build/assets/index-BSgOKi0E.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"6ca1-Q/u5ZisxS3RGtsoJaSJgD/uH68s\"",
    "mtime": "2024-09-14T08:39:43.376Z",
    "size": 27809,
    "path": "../public/_build/assets/index-BSgOKi0E.js"
  },
  "/_build/assets/index-BSgOKi0E.js.br": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "br",
    "etag": "\"1cbb-GDFBy3bDaIi3nPZMRiOBshvB+T0\"",
    "mtime": "2024-09-14T08:39:43.447Z",
    "size": 7355,
    "path": "../public/_build/assets/index-BSgOKi0E.js.br"
  },
  "/_build/assets/index-BSgOKi0E.js.gz": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"2009-U87j3+mB1aCzt0TXfyYlx3yyAOc\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 8201,
    "path": "../public/_build/assets/index-BSgOKi0E.js.gz"
  },
  "/_build/assets/index-DYNFtd-j.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"485-cPsF7YsUyrBZWidvPB0BprPaFNQ\"",
    "mtime": "2024-09-14T08:39:43.376Z",
    "size": 1157,
    "path": "../public/_build/assets/index-DYNFtd-j.js"
  },
  "/_build/assets/index-DYNFtd-j.js.br": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "br",
    "etag": "\"221-RI2jM0yZABR29aQD/9rabgK7EdQ\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 545,
    "path": "../public/_build/assets/index-DYNFtd-j.js.br"
  },
  "/_build/assets/index-DYNFtd-j.js.gz": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"272-IEvT8WXbJszjJ2RqolZuhJ8/4jw\"",
    "mtime": "2024-09-14T08:39:43.422Z",
    "size": 626,
    "path": "../public/_build/assets/index-DYNFtd-j.js.gz"
  },
  "/_build/assets/login-BYDnqFuM.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"4b0-dn2PKK8YVZk6wNqJNhoQ4747TDk\"",
    "mtime": "2024-09-14T08:39:43.376Z",
    "size": 1200,
    "path": "../public/_build/assets/login-BYDnqFuM.js"
  },
  "/_build/assets/login-BYDnqFuM.js.br": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "br",
    "etag": "\"209-0KEASaz1wSBqCWAh2pWBvZUgrsQ\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 521,
    "path": "../public/_build/assets/login-BYDnqFuM.js.br"
  },
  "/_build/assets/login-BYDnqFuM.js.gz": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"276-7Hh+jlg9nm1IyfGQXjj6ej/bu4o\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 630,
    "path": "../public/_build/assets/login-BYDnqFuM.js.gz"
  },
  "/_build/assets/web-BZwEqE-T.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"306d-L4g5okB6YUbrgO9klp4bOoCgdn8\"",
    "mtime": "2024-09-14T08:39:43.376Z",
    "size": 12397,
    "path": "../public/_build/assets/web-BZwEqE-T.js"
  },
  "/_build/assets/web-BZwEqE-T.js.br": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "br",
    "etag": "\"1202-Dw97zrNFVvm2UefoMWzVTMv4cMg\"",
    "mtime": "2024-09-14T08:39:43.427Z",
    "size": 4610,
    "path": "../public/_build/assets/web-BZwEqE-T.js.br"
  },
  "/_build/assets/web-BZwEqE-T.js.gz": {
    "type": "text/javascript; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"138f-nO6tTUbo4E8ug0ZkXaQjLzECsoA\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 5007,
    "path": "../public/_build/assets/web-BZwEqE-T.js.gz"
  },
  "/_server/assets/app-BYLN711c.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"e5b-MioCm5vPIX1A6a1DaceofOgm7QA\"",
    "mtime": "2024-09-14T08:39:43.379Z",
    "size": 3675,
    "path": "../public/_server/assets/app-BYLN711c.css"
  },
  "/_server/assets/app-BYLN711c.css.br": {
    "type": "text/css; charset=utf-8",
    "encoding": "br",
    "etag": "\"3d2-6ljG95ewl4x6McF+WaFReie1IZU\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 978,
    "path": "../public/_server/assets/app-BYLN711c.css.br"
  },
  "/_server/assets/app-BYLN711c.css.gz": {
    "type": "text/css; charset=utf-8",
    "encoding": "gzip",
    "etag": "\"4a7-Pn/kL+fdBVqzud9Ep9FGX2esVeE\"",
    "mtime": "2024-09-14T08:39:43.423Z",
    "size": 1191,
    "path": "../public/_server/assets/app-BYLN711c.css.gz"
  },
  "/_server/assets/auth-logo-Bwvg09ZW.png": {
    "type": "image/png",
    "etag": "\"4834-oMPK90UmB6bkEqljYCIXVqNTIbE\"",
    "mtime": "2024-09-14T08:39:43.379Z",
    "size": 18484,
    "path": "../public/_server/assets/auth-logo-Bwvg09ZW.png"
  },
  "/_server/assets/google-Bp_336oh.png": {
    "type": "image/png",
    "etag": "\"5181-jkJBOZuu++j4/v+rD+Z2guFA4bE\"",
    "mtime": "2024-09-14T08:39:43.379Z",
    "size": 20865,
    "path": "../public/_server/assets/google-Bp_336oh.png"
  },
  "/_server/assets/hide-CcLQG700.png": {
    "type": "image/png",
    "etag": "\"397a-mvu2owgxW3w1RKvsEO/Fk0iRo/s\"",
    "mtime": "2024-09-14T08:39:43.379Z",
    "size": 14714,
    "path": "../public/_server/assets/hide-CcLQG700.png"
  }
};
...
const g="Invariant Violation",{setPrototypeOf:re$1=function(e,r){return e.__proto__=r,e}}=Object;class x extends Error{framesToPop=1;name=g;constructor(r=g){super(typeof r=="number"?`${g}: ${r} (see https://github.com/apollographql/invariant-packages)`:r),re$1(this,x.prototype);}}function se$1(e,r){if(!e)throw new x(r)}const ne$1={preload(){wt$1();}},N$1=[{page:!0,$component:{src:"src/routes/[...404].tsx?pick=default&pick=$css",build:()=>import('./build/_...404_.mjs'),import:()=>import('./build/_...404_.mjs')},path:"/*404",filePath:"/home/ssmoss/Desktop/solid-auth/test-folder/lib/routes/[...404].tsx"},{page:!0,$component:{src:"src/routes/index.tsx?pick=default&pick=$css",build:()=>import('./build/index.mjs'),import:()=>import('./build/index.mjs')},$$route:{require:()=>({route:ne$1}),src:"lib/routes/index.tsx?pick=route"},path:"/",filePath:"/home/ssmoss/Desktop/solid-auth/test-folder/lib/routes/index.tsx"},{page:!0,$component:{src:"src/routes/login.tsx?pick=default&pick=$css",build:()=>import('./build/login.mjs'),import:()=>import('./build/login.mjs')},path:"/login",filePath:"/home/ssmoss/Desktop/solid-auth/test-folder/lib/routes/login.tsx"}],oe$1=ae$1(N$1.filter(e=>e.page));function ae$1(e){function r(t,o,n,a){const i=Object.values(t).find(c=>n.startsWith(c.id+"/"));return i?(r(i.children||(i.children=[]),o,n.slice(i.id.length)),t):(t.push({...o,id:n,path:n.replace(/\/\([^)/]+\)/g,"").replace(/\([^)/]+\)/g,"")}),t)}return e.sort((t,o)=>t.path.length-o.path.length).reduce((t,o)=>r(t,o,o.path,o.path),[])}function ie$1(e){return e.$GET||e.$POST||e.$PUT||e.$PATCH||e.$DELETE}createRouter$1({routes:N$1.reduce((e,r)=>{if(!ie$1(r))return e;let t=r.path.replace(/\/\([^)/]+\)/g,"").replace(/\([^)/]+\)/g,"").replace(/\*([^/]*)/g,(o,n)=>`**:${n}`);if(/:[^/]*\?/g.test(t))throw new Error(`Optional parameters are not supported in API routes: ${t}`);if(e[t])throw new Error(`Duplicate API routes for "${t}" found at "${e[t].route.path}" and "${r.path}"`);return e[t]={route:r},e},{})});var ue$1=" ";const le$1={style:e=>ssrElement("style",e.attrs,()=>escape(e.children),!0),link:e=>ssrElement("link",e.attrs,void 0,!0),script:e=>e.attrs.src?ssrElement("script",mergeProps(()=>e.attrs,{get id(){return e.key}}),()=>ssr(ue$1),!0):null,noscript:e=>ssrElement("noscript",e.attrs,()=>escape(e.children),!0)};function pe$1(e,r){let{tag:t,attrs:{key:o,...n}={key:void 0},children:a}=e;return le$1[t]({attrs:{...n,nonce:r},key:o,children:a})}function de$1(e,r,t,o="default"){return lazy(async()=>{{const a=(await e.import())[o],c=(await r.inputs?.[e.src].assets()).filter(d=>d.tag==="style"||d.attrs.rel==="stylesheet");return {default:d=>[...c.map(l=>pe$1(l)),createComponent(a,d)]}}})}function fe$1(){function e(t){return {...t,...t.$$route?t.$$route.require().route:void 0,info:{...t.$$route?t.$$route.require().route.info:{},filesystem:!0},component:t.$component&&de$1(t.$component,globalThis.MANIFEST.client,globalThis.MANIFEST.ssr),children:t.children?t.children.map(e):void 0}}return oe$1.map(e)}function he$1(e){const r=ft(e.nativeEvent,"flash");if(!r)return;let t=JSON.parse(r);if(!t||!t.result)return;const o=[...t.input.slice(0,-1),new Map(t.input[t.input.length-1])];lt$1(e.nativeEvent,"flash","",{maxAge:0});const n=t.error?new Error(t.result):t.result;return {input:o,url:t.url,pending:!1,result:t.thrown?void 0:n,error:t.thrown?n:void 0}}async function me$1(e){const r=globalThis.MANIFEST.client;return globalThis.MANIFEST.ssr,e.response.headers.set("Content-Type","text/html"),Object.assign(e,{manifest:await r.json(),assets:[...await r.inputs[r.handler].assets()],router:{submission:he$1(e)},routes:fe$1(),complete:!1,$islands:new Set})}const ge$1=new Set([301,302,303,307,308]);function ye$1(e){return e.status&&ge$1.has(e.status)?e.status:302}function we$1(e){const r=new TextEncoder().encode(e),t=r.length,o=t.toString(16),n="00000000".substring(0,8-o.length)+o,a=new TextEncoder().encode(`;0x${n};`),i=new Uint8Array(12+t);return i.set(a),i.set(r,12),i}function I$1(e,r){return new ReadableStream({start(t){crossSerializeStream(r,{scopeId:e,plugins:[CustomEventPlugin,DOMExceptionPlugin,EventPlugin,FormDataPlugin,HeadersPlugin,ReadableStreamPlugin,RequestPlugin,ResponsePlugin,URLSearchParamsPlugin,URLPlugin],onSerialize(o,n){t.enqueue(we$1(n?`(${getCrossReferenceHeader(e)},${o})`:o));},onDone(){t.close();},onError(o){t.error(o);}});}})}async function Re$1(e){const r=ht$1(e),t=r.request,o=t.headers.get("X-Server-Id"),n=t.headers.get("X-Server-Instance"),a=t.headers.has("X-Single-Flight"),i=new URL(t.url);let c,p;if(o)se$1(typeof o=="string","Invalid server function"),[c,p]=o.split("#");else if(c=i.searchParams.get("id"),p=i.searchParams.get("name"),!c||!p)throw new Error("Invalid request");const d=(await globalThis.MANIFEST["server-fns"].chunks[c].import())[p];let l=[];if(!n||e.method==="GET"){const s=i.searchParams.get("args");if(s){const u=JSON.parse(s);(u.t?fromJSON(u,{plugins:[CustomEventPlugin,DOMExceptionPlugin,EventPlugin,FormDataPlugin,HeadersPlugin,ReadableStreamPlugin,RequestPlugin,ResponsePlugin,URLSearchParamsPlugin,URLPlugin]}):u).forEach(f=>l.push(f));}}if(e.method==="POST"){const s=t.headers.get("content-type"),u=e.node.req,f=u instanceof ReadableStream,q=f&&u.locked,C=f?u:u.body;if(s?.startsWith("multipart/form-data")||s?.startsWith("application/x-www-form-urlencoded"))l.push(await(q?t:new Request(t,{...t,body:C})).formData());else if(s?.startsWith("application/json")){const B=q?t:new Request(t,{...t,body:C});l=fromJSON(await B.json(),{plugins:[CustomEventPlugin,DOMExceptionPlugin,EventPlugin,FormDataPlugin,HeadersPlugin,ReadableStreamPlugin,RequestPlugin,ResponsePlugin,URLSearchParamsPlugin,URLPlugin]});}}try{let s=await provideRequestEvent(r,async()=>(sharedConfig.context={event:r},r.locals.serverFunctionMeta={id:c+"#"+p},d(...l)));if(a&&n&&(s=await M(r,s)),s instanceof Response){if(s.headers&&s.headers.has("X-Content-Raw"))return s;n&&(s.headers&&pt$1(e,s.headers),s.status&&(s.status<300||s.status>=400)&&L$2(e,s.status),s.customBody?s=await s.customBody():s.body==null&&(s=null));}return n?(gt$1(e,"content-type","text/javascript"),I$1(n,s)):O(s,t,l)}catch(s){if(s instanceof Response)a&&n&&(s=await M(r,s)),s.headers&&pt$1(e,s.headers),s.status&&(!n||s.status<300||s.status>=400)&&L$2(e,s.status),s.customBody?s=s.customBody():s.body==null&&(s=null),gt$1(e,"X-Error","true");else if(n){const u=s instanceof Error?s.message:typeof s=="string"?s:"true";gt$1(e,"X-Error",u.replace(/[\r\n]+/g,""));}else s=O(s,t,l,!0);return n?(gt$1(e,"content-type","text/javascript"),I$1(n,s)):s}}function O(e,r,t,o){const n=new URL(r.url),a=e instanceof Error;let i=new URL(r.headers.get("referer")).toString(),c=302;return e instanceof Response&&e.headers.has("Location")&&(i=new URL(e.headers.get("Location"),n.origin+"").toString(),c=ye$1(e)),new Response(null,{status:c,headers:{Location:i,...e?{"Set-Cookie":`flash=${JSON.stringify({url:n.pathname+encodeURIComponent(n.search),result:a?e.message:e,thrown:o,error:a,input:[...t.slice(0,-1),[...t[t.length-1].entries()]]})}; Secure; HttpOnly;`}:{}}})}let y$1;async function M(e,r){let t,o=new URL(e.request.headers.get("referer")).toString();r instanceof Response&&(r.headers.has("X-Revalidate")&&(t=r.headers.get("X-Revalidate").split(",")),r.headers.has("Location")&&(o=new URL(r.headers.get("Location"),new URL(e.request.url).origin+"").toString()));const n=_e$2(e);return n.request=new Request(o),await provideRequestEvent(n,async()=>{await me$1(n),y$1||(y$1=(await import('./build/app.mjs')).default),n.router.dataOnly=t||!0,n.router.previousUrl=e.request.headers.get("referer");try{renderToString(()=>{sharedConfig.context.event=n,y$1();});}catch(c){console.log(c);}const a=n.router.data;if(!a)return r;let i=!1;for(const c in a)a[c]===void 0?delete a[c]:i=!0;return i&&(r instanceof Response?r.customBody&&(a._$value=r.customBody()):(a._$value=r,r=new Response(null,{status:200})),r.customBody=()=>a,r.headers.set("X-Single-Flight","true")),r})}const Le$2=eventHandler(Re$1);
...
function Se$1(e) {
  let t;
  const n = N(e), r = { duplex: "half", method: e.method, headers: e.headers };
...
function ve$1(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: Se$1(e), url: N(e) }, e.web.request;
}
function be$1() {
  return Ie$1();
}
...
function c(e) {
  return function(...t) {
    ...
    let n = t[0];
    if (Ee$1(n))
      t[0] = n instanceof H3Event || n.__is_event__ ? n : n[D];
    else {
...
const N = c(getRequestURL), $e$1 = c(getRequestIP), L$1 = c(setResponseStatus), k$1 = c(getResponseStatus), xe$1 = c(getResponseStatusText), $ = c(getResponseHeaders), F = c(getResponseHeader), Ce$1 = c(setResponseHeader), He$1 = c(appendResponseHeader), lt = c(sendRedirect), gt = c(getCookie), ht = c(setCookie), Ae$1 = c(useSession), pt = c(setHeader), Te$1 = c(getRequestWebStream), Oe$1 = c(removeResponseHeader), qe$1 = c(ve$1);
function Ue$1() {
  var _a;
...
function Ie$1() {
  return Ue$1().use().event;
}
const T = Symbol("fetchEvent");
function _e$1(e) {
  return { request: qe$1(e), response: ke$1(e), clientAddress: $e$1(e), locals: {}, nativeEvent: e };
}
function Pe$1(e) {
  return { ...e };
}
...
let Le$1 = class Le {
  ...
  set(t, n) {
    return Ce$1(this.event, t, n);
  }
  delete(t) {
    return Oe$1(this.event, t);
  }
  append(t, n) {
    He$1(this.event, t, n);
  }
  getSetCookie() {
    const t = F(this.event, "Set-Cookie");
    return Array.isArray(t) ? t : [t];
  }
  forEach(t) {
    return Object.entries($(this.event)).forEach(([n, r]) => t(Array.isArray(r) ? r.join(", ") : r, n, this));
  }
  entries() {
    return Object.entries($(this.event)).map(([t, n]) => [t, Array.isArray(n) ? n.join(", ") : n])[Symbol.iterator]();
  }
  keys() {
    return Object.keys($(this.event))[Symbol.iterator]();
  }
  values() {
    return Object.values($(this.event)).map((t) => Array.isArray(t) ? t.join(", ") : t)[Symbol.iterator]();
  }
  [Symbol.iterator]() {
...
function H(e, t, n) {
  ...
  const r = "";
  return new Proxy(e, { get(s, o, d) {
    return o === "url" ? `${r}/_server?id=${encodeURIComponent(t)}&name=${encodeURIComponent(n)}` : o === "GET" ? d : s[o];
  }, apply(s, o, d) {
    const u = getRequestEvent();
    if (!u)
      throw new Error("Cannot call server function outside of a request");
    const f = Pe$1(u);
    return f.locals.serverFunctionMeta = { id: t + "#" + n }, f.serverOnly = true, provideRequestEvent(f, () => e.apply(o, d));
  } });
}
const Fe = "http://sr";
function je(e, t) {
...
const We = createContext$1();
createContext$1();
const K = () => je(useContext(We), "<A> and 'use' router primitives can be only used inside a Route."), Me$1 = () => K().navigatorFactory();
let Be$1;
function De$1() {
  return Be$1;
}
const Ne$1 = "Location", Ke = 5e3, Xe = 18e4;
let b$1 = /* @__PURE__ */ new Map();
isServer || setInterval(() => {
  const e = Date.now();
  for (let [t, n] of b$1.entries())
    !n[3].count && e - n[0] > Xe && b$1.delete(t);
}, 3e5);
function I() {
  if (!isServer)
    return b$1;
...
function X(e, t) {
  ...
  for (let n of b$1.keys())
    (e === void 0 || ze$1(n, e)) && t(b$1.get(n));
}
function A(e, t) {
  e.GET && (e = e.GET);
  const n = (...r) => {
    const s = I(), o = De$1(), u = getOwner() ? Me$1() : void 0, f = Date.now(), g = t + q(r);
    let i = s.get(g), m;
    if (isServer) {
      const a = getRequestEvent();
      if (a) {
        const y = (a.router || (a.router = {})).dataOnly;
        if (y) {
          const w = a && (a.router.data || (a.router.data = {}));
          if (w && g in w)
            return w[g];
          if (Array.isArray(y) && !y.includes(g))
            return w[g] = void 0, Promise.resolve();
        }
      }
    }
    if (getListener() && !isServer && (m = true, onCleanup(() => i[3].count--)), i && i[0] && (isServer || o === "native" || i[3].count || Date.now() - i[0] < Ke)) {
      m && (i[3].count++, i[3][0]()), i[2] === "preload" && o !== "preload" && (i[0] = f);
      let a = i[1];
      return a = "then" in i[1] ? i[1].then(p(false), p(true)) : p(false)(i[1]), !isServer && o === "navigate" && startTransition(() => i[3][1](i[0])), a;
    }
    let h = !isServer && sharedConfig.context && sharedConfig.has(g) ? sharedConfig.load(g) : e(...r);
    if (i ? (i[0] = f, i[1] = h, i[2] = o, !isServer && o === "navigate" && startTransition(() => i[3][1](i[0]))) : (s.set(g, i = [f, h, o, createSignal(f)]), i[3].count = 0), m && (i[3].count++, i[3][0]()), isServer) {
      const a = getRequestEvent();
      if (a && a.router.dataOnly)
        return a.router.data[g] = h;
    }
    if (h = "then" in h ? h.then(p(false), p(true)) : p(false)(h), isServer && sharedConfig.context && sharedConfig.context.async && !sharedConfig.context.noHydrate) {
      const a = getRequestEvent();
      (!a || !a.serverOnly) && sharedConfig.context.serialize(g, h);
    }
    return h;
    function p(a) {
      return async (y) => {
        if (y instanceof Response) {
          const w = y.headers.get(Ne$1);
          if (w !== null) {
            if (u && w.startsWith("/"))
              startTransition(() => {
                u(w, { replace: true });
              ...
              P && (P.response = { status: 302, headers: new Headers({ Location: w }) });
            }
            return;
          }
  ...
  return n.keyFor = (...r) => t + q(r), n.key = t, n;
}
A.set = (e, t) => {
  const n = I(), r = Date.now();
  let s = n.get(e);
  s ? (s[0] = r, s[1] = t, s[2] = "preload") : (n.set(e, s = [r, t, , createSignal(r)]), s[3].count = 0);
};
A.clear = () => I().clear();
function ze$1(e, t) {
  for (let n of t)
...
function q(e) {
  return JSON.stringify(e, (t, n) => Je(n) ? Object.keys(n).sort().reduce((r, s) => (r[s] = n[s], r), {}) : n);
}
function Je(e) {
  let t;
...
function Qe(e, t) {
  const n = K(), r = createMemo(() => n.submissions[0]().filter((s) => s.url === e.toString() && !t));
  return new Proxy([], { get(s, o) {
    return o === $TRACK ? r() : o === "pending" ? r().some((d) => !d.result) : r()[o];
  } });
}
function wt(e, t) {
  const n = Qe(e, t);
...
function G(e, t) {
  function n(...s) {
    const o = this.r, d = this.f, u = (o.singleFlight && e.withOptions ? e.withOptions({ headers: { "X-Single-Flight": "true" } }) : e)(...s), [f, g] = createSignal();
    let i;
    function m(h) {
      return async (p) => {
        const a = await Ye(p, h, o.navigatorFactory());
        if (!a)
          return i.clear();
        if (g(a), a.error && !d)
          throw a.error;
    ...
    return o.submissions[1]((h) => [...h, i = { input: s, url: r, get result() {
      var _a;
      return (_a = f()) == null ? void 0 : _a.data;
    }, get error() {
      var _a;
      return (_a = f()) == null ? void 0 : _a.error;
    }, get pending() {
      return !f();
    }, clear() {
      o.submissions[1]((p) => p.filter((a) => a.input !== s));
    }, retry() {
      return g(void 0), e(...s).then(m(), m(true));
    } }]), u.then(m(), m(true));
  }
  const r = e.url || t || (isServer ? "" : `https://action/${Ve(e.toString())}`);
  return z(n, r);
}
function z(e, t) {
  return e.toString = () => {
    ...
    return s.searchParams.set("args", q(n)), z(r, (s.origin === "https://action" ? s.origin : "") + s.pathname + s.search);
  }, e.url = t, isServer || (j.set(t, e), getOwner() && onCleanup(() => j.delete(t))), e;
}
const Ve = (e) => e.split("").reduce((t, n) => (t << 5) - t + n.charCodeAt(0) | 0, 0);
async function Ye(e, t, n) {
  let r, s, o, d;
  if (e instanceof Response) {
    if (e.headers.has("X-Revalidate") && (o = e.headers.get("X-Revalidate").split(",")), e.customBody && (r = s = await e.customBody(), e.headers.has("X-Single-Flight") && (r = r._$value, delete s._$value, d = Object.keys(s))), e.headers.has("Location")) {
      const u = e.headers.get("Location") || "/";
      u.startsWith("http") ? window.location.href = u : n(u);
    }
  } else {
    if (t)
      return { error: e };
  ...
  return X(o, (u) => u[0] = 0), d && d.forEach((u) => A.set(u, s[u])), await Ge$1(o, false), r != null ? { data: r } : void 0;
}
function _(e, t = 302) {
  let n, r;
  typeof t == "number" ? n = { status: t } : ({ revalidate: r, ...n } = t, typeof n.status > "u" && (n.status = 302));
  const s = new Headers(n.headers);
  return s.set("Location", e), r && s.set("X-Revalidate", r.toString()), new Response(null, { ...n, headers: s });
}
const v = createStorage({ driver: pe$2({ base: "./.data" }) });
v.setItem("users:data", [{ id: 0, username: "kody", password: "twixrox" }]);
v.setItem("users:counter", 1);
const C$1 = { user: { async create({ data: e }) {
  const [{ value: t }, { value: n }] = await v.getItems(["users:data", "users:counter"]), r = { ...e, id: n };
  return await Promise.all([v.setItem("users:data", [...t, r]), v.setItem("users:counter", n + 1)]), r;
}, async findUnique({ where: { username: e = void 0, id: t = void 0 } }) {
  const n = await v.getItem("users:data");
  return t !== void 0 ? n.find((r) => r.id === t) : n.find((r) => r.username === e);
} } }, E = { getSession: async () => {
  var _a;
  const e = await Ae$1({ password: (_a = process.env.SESSION_SECRET) != null ? _a : "areallylongsecretthatyoushouldreplace" });
  return { ...e, update: async (t) => {
    const n = { ...e.data };
    t(n), await e.update((r) => ({ ...r, ...n }));
  } };
}, login: async (e, t) => {
  const n = await C$1.user.findUnique({ where: { username: e } });
  if (!n || t !== n.password)
    throw new Error("Invalid login");
  return { ...n, id: n.id };
}, register: async (e, t) => {
  if (await C$1.user.findUnique({ where: { username: e } }))
    throw new Error("User already exists");
  return C$1.user.create({ data: { username: e, password: t } });
}, logout: async () => {
  const e = await E.getSession();
  (e == null ? void 0 : e.data.userId) && await e.update((t) => {
    t.userId = void 0;
  });
}, validateUsername: (e) => {
...
} }, mt = A(H(et, "c_5810", "$$function0"), "user"), Rt = G(H(tt$1, "c_5810", "$$function1")), Ze = H(nt, "c_5810", "$$function2"), St = G(H(rt, "c_5810", "$$function3"));
async function et() {
  try {
    const e = await E.getSession(), t = Number(e.data.userId);
    if (t === void 0)
      throw new Error("User not found");
    const n = await C$1.user.findUnique({ where: { id: t } });
    if (!n)
      throw new Error("User not found");
    return { id: n.id, username: n.username };
  } catch {
    await E.logout(), _("/login");
  }
}
...
async function nt(e, t) {
  const n = String(e.get("username")), r = String(e.get("password")), s = String(e.get("loginType"));
  let o = t.validateUsername(n) || t.validatePassword(r);
  if (o)
    return new Error(o);
  try {
    const d = await (s !== "login" ? t.register(n, r) : t.login(n, r));
    await (await t.getSession()).update((f) => {
      f.userId = d.id.toString();
    });
  } catch (d) {
    return d;
  }
...
async function rt() {
  return await E.logout(), _("/login");
}

const ne = "_increment_eeq8g_1", re = { increment: ne };
var se = ["<button", ' type="button">Clicks: <!--$-->', "<!--/--></button>"];
const oe = () => {
  const [e, n] = createSignal(0);
  return ssr(se, ssrHydrationKey() + ssrAttribute("class", escape(re.increment, true), false), escape(e()));
}, ae = "_loginFormContainer_1a4le_1", ie = "_loginBox_1a4le_10", le = "_lineBreak_1a4le_137", ce = "_signInText_1a4le_145", ue = "_lineBreakContainer_1a4le_161", pe = "_lineBreakText_1a4le_170", de = "_newUserLine_1a4le_178", p = { loginFormContainer: ae, loginBox: ie, "log-in-button": "_log-in-button_1a4le_23", "google-button": "_google-button_1a4le_49", "google-logo": "_google-logo_1a4le_76", "form-control": "_form-control_1a4le_85", "form-control-group": "_form-control-group_1a4le_108", "password-container": "_password-container_1a4le_120", "hide-logo": "_hide-logo_1a4le_126", lineBreak: le, signInText: ce, "login-image": "_login-image_1a4le_155", lineBreakContainer: ue, lineBreakText: pe, newUserLine: de }, me = "/_build/assets/auth-logo-Bwvg09ZW.png", he = "/_build/assets/google-Bp_336oh.png", fe = "/_build/assets/hide-CcLQG700.png";
var ge = ["<div", "><form", "><div", "><img", ' alt="solidLogo"></div><h2', ">Sign In</h2><input", ' id="usernameInput" type="email" placeholder="Username"><div', "><input", ' id="passwordInput" type="password" placeholder="Password"><img', ' alt="hide logo"', "></div><button", ' type="submit">Log In</button><div', "></div><button", ' type="button"><img', ' alt="google-logo"><span>Sign in with Google</span></button><div', '><p>New to Solid Auth?</p><a href="#">Create New User</a></div></form></div>'];
const _e = () => ssr(ge, ssrHydrationKey() + ssrAttribute("class", escape(p.loginFormContainer, true), false), ssrAttribute("class", escape(p.loginBox, true), false), ssrAttribute("class", escape(p["login-image"], true), false), ssrAttribute("src", escape(me, true), false), ssrAttribute("class", escape(p.signInText, true), false), ssrAttribute("class", escape(p["form-control"], true), false), ssrAttribute("class", escape(p["password-container"], true), false), ssrAttribute("class", escape(p["form-control"], true), false), ssrAttribute("src", escape(fe, true), false), ssrAttribute("class", escape(p["hide-logo"], true), false), ssrAttribute("class", escape(p["log-in-button"], true), false), ssrAttribute("class", escape(p.lineBreakContainer, true), false), ssrAttribute("class", escape(p["google-button"], true), false), ssrAttribute("src", escape(he, true), false) + ssrAttribute("class", escape(p["google-logo"], true), false), ssrAttribute("class", escape(p.newUserLine, true), false));
function $e() {
  return [createComponent$1(oe, {}), createComponent$1(_e, {})];
}
const B = isServer ? (e) => {
  const n = getRequestEvent();
  return n.response.status = e.code, n.response.statusText = e.text, onCleanup(() => !n.nativeEvent.handled && !n.complete && (n.response.status = 200)), null;
} : (e) => null;
var ve = ["<span", ' style="font-size:1.5em;text-align:center;position:fixed;left:0px;bottom:55%;width:100%;">', "</span>"], we = ["<span", ' style="font-size:1.5em;text-align:center;position:fixed;left:0px;bottom:55%;width:100%;">500 | Internal Server Error</span>'];
const ye = (e) => {
  const n = isServer ? "500 | Internal Server Error" : "Error | Uncaught Client Exception";
  return createComponent$1(ErrorBoundary, { fallback: (t) => (console.error(t), [ssr(ve, ssrHydrationKey(), escape(n)), createComponent$1(B, { code: 500 })]), get children() {
    return e.children;
  } });
}, be = (e) => {
  let n = false;
  ...
  return n ? [ssr(we, ssrHydrationKey()), createComponent$1(B, { code: 500 })] : t;
};
var Ee = " ";
const Te = { style: (e) => ssrElement("style", e.attrs, () => escape(e.children), true), link: (e) => ssrElement("link", e.attrs, void 0, true), script: (e) => e.attrs.src ? ssrElement("script", mergeProps(() => e.attrs, { get id() {
  return e.key;
} }), () => ssr(Ee), true) : null, noscript: (e) => ssrElement("noscript", e.attrs, () => escape(e.children), true) };
function y(e, n) {
  let { tag: t, attrs: { key: o, ...s } = { key: void 0 }, children: i } = e;
  return Te[t]({ attrs: { ...s, nonce: n }, key: o, children: i });
}
var S = ["<script", ">", "<\/script>"], Se = ["<script", ' type="module"', " async", "><\/script>"], Ce = ["<script", ' type="module" async', "><\/script>"];
const ke = ssr("<!DOCTYPE html>");
function L(e, n, t = []) {
  for (let o = 0; o < n.length; o++) {
    ...
    if (s.children) {
      const r = e.slice(1);
      if (r.length === 0 || (i = L(r, s.children, i), !i))
        continue;
    }
    return i;
  }
...
function xe(e) {
  ...
  return Promise.resolve().then(async () => {
    ...
    if (n.router && n.router.matches) {
      const i = [...n.router.matches];
      for (; i.length && (!i[0].info || !i[0].info.filesystem); )
        i.shift();
      const r = i.length && L(i, n.routes);
      if (r) {
        const l = globalThis.MANIFEST.client.inputs;
        for (let _ = 0; _ < r.length; _++) {
          const m = r[_], $ = l[m.$component.src];
          s.push($.assets());
        }
      }
    }
    o = await Promise.all(s).then((i) => [...new Map(i.flat().map((r) => [r.attrs.key, r])).values()].filter((r) => r.attrs.rel === "modulepreload" && !n.assets.find((l) => l.attrs.key === r.attrs.key)));
  }), useAssets(() => o.length ? o.map((s) => y(s)) : void 0), createComponent$1(NoHydration, { get children() {
    return [ke, createComponent$1(be, { get children() {
      return createComponent$1(e.document, { get assets() {
        return [createComponent$1(HydrationScript, {}), n.assets.map((s) => y(s, t))];
      }, get scripts() {
        return t ? [ssr(S, ssrHydrationKey() + ssrAttribute("nonce", escape(t, true), false), `window.manifest = ${JSON.stringify(n.manifest)}`), ssr(Se, ssrHydrationKey(), ssrAttribute("nonce", escape(t, true), false), ssrAttribute("src", escape(globalThis.MANIFEST.client.inputs[globalThis.MANIFEST.client.handler].output.path, true), false))] : [ssr(S, ssrHydrationKey(), `window.manifest = ${JSON.stringify(n.manifest)}`), ssr(Ce, ssrHydrationKey(), ssrAttribute("src", escape(globalThis.MANIFEST.client.inputs[globalThis.MANIFEST.client.handler].output.path, true), false))];
      }, get children() {
        return createComponent$1(Hydration, { get children() {
          return createComponent$1(ye, { get children() {
            return createComponent$1($e, {});
          } });
        } });
      } });
    } })];
...
const Ae = { preload() {
  mt();
} }, R = [{ page: true, $component: { src: "src/routes/[...404].tsx?pick=default&pick=$css", build: () => import('./build/_...404_2.mjs'), import: () => import('./build/_...404_2.mjs') }, path: "/*404", filePath: "/home/ssmoss/Desktop/solid-auth/test-folder/lib/routes/[...404].tsx" }, { page: true, $component: { src: "src/routes/index.tsx?pick=default&pick=$css", build: () => import('./build/index2.mjs'), import: () => import('./build/index2.mjs') }, $$route: { require: () => ({ route: Ae }), src: "lib/routes/index.tsx?pick=route" }, path: "/", filePath: "/home/ssmoss/Desktop/solid-auth/test-folder/lib/routes/index.tsx" }, { page: true, $component: { src: "src/routes/login.tsx?pick=default&pick=$css", build: () => import('./build/login2.mjs'), import: () => import('./build/login2.mjs') }, path: "/login", filePath: "/home/ssmoss/Desktop/solid-auth/test-folder/lib/routes/login.tsx" }], Ie = Be(R.filter((e) => e.page));
function Be(e) {
  function n(t, o, s, i) {
    const r = Object.values(t).find((l) => s.startsWith(l.id + "/"));
    return r ? (n(r.children || (r.children = []), o, s.slice(r.id.length)), t) : (t.push({ ...o, id: s, path: s.replace(/\/\([^)/]+\)/g, "").replace(/\([^)/]+\)/g, "") }), t);
  }
  return e.sort((t, o) => t.path.length - o.path.length).reduce((t, o) => n(t, o, o.path, o.path), []);
}
function Le(e, n) {
  const t = Pe.lookup(e);
  if (t && t.route) {
...
const Pe = createRouter$1({ routes: R.reduce((e, n) => {
  if (!Re(n))
    return e;
  let t = n.path.replace(/\/\([^)/]+\)/g, "").replace(/\([^)/]+\)/g, "").replace(/\*([^/]*)/g, (o, s) => `**:${s}`);
  if (/:[^/]*\?/g.test(t))
...
function Me(e, n, t, o = "default") {
  return lazy(async () => {
    var _a;
    {
      const i = (await e.import())[o], l = (await ((_a = n.inputs) == null ? void 0 : _a[e.src].assets())).filter((m) => m.tag === "style" || m.attrs.rel === "stylesheet");
      return { default: (m) => [...l.map(($) => y($)), createComponent(i, m)] };
    }
  });
}
function Ne() {
  function e(t) {
    return { ...t, ...t.$$route ? t.$$route.require().route : void 0, info: { ...t.$$route ? t.$$route.require().route.info : {}, filesystem: true }, component: t.$component && Me(t.$component, globalThis.MANIFEST.client, globalThis.MANIFEST.ssr), children: t.children ? t.children.map(e) : void 0 };
  }
  return Ie.map(e);
}
function qe(e) {
  const n = gt(e.nativeEvent, "flash");
  if (!n)
    return;
  let t = JSON.parse(n);
  if (!t || !t.result)
    return;
  const o = [...t.input.slice(0, -1), new Map(t.input[t.input.length - 1])];
  ht(e.nativeEvent, "flash", "", { maxAge: 0 });
  const s = t.error ? new Error(t.result) : t.result;
  return { input: o, url: t.url, pending: false, result: t.thrown ? void 0 : s, error: t.thrown ? s : void 0 };
}
async function He(e) {
  const n = globalThis.MANIFEST.client;
  return globalThis.MANIFEST.ssr, e.response.headers.set("Content-Type", "text/html"), Object.assign(e, { manifest: await n.json(), assets: [...await n.inputs[n.handler].assets()], router: { submission: qe(e) }, routes: Ne(), complete: false, $islands: /* @__PURE__ */ new Set() });
}
...
function Oe(e, n, t = {}) {
  return eventHandler({ handler: (o) => {
    ...
    return provideRequestEvent(s, async () => {
      const i = Le(new URL(s.request.url).pathname, s.request.method);
      if (i) {
        const g = (await i.handler.import())[s.request.method];
        s.params = i.params || {}, sharedConfig.context = { event: s };
        const E = await g(s);
        if (E !== void 0)
          return E;
      ...
      const r = await n(s), l = typeof t == "function" ? await t(r) : { ...t }, _ = l.mode || "stream";
      if (l.nonce && (r.nonce = l.nonce), _ === "sync") {
        const f = renderToString(() => (sharedConfig.context.event = r, e(r)), l);
        if (r.complete = true, r.response && r.response.headers.get("Location")) {
          const g = b(r.response);
          return lt(o, r.response.headers.get("Location"), g);
        }
        return f;
      }
      if (l.onCompleteAll) {
      ...
      if (l.onCompleteShell) {
        ...
        l.onCompleteShell = C(r, o);
      const m = renderToStream(() => (sharedConfig.context.event = r, e(r)), l);
      if (r.response && r.response.headers.get("Location")) {
        const f = b(r.response);
        return lt(o, r.response.headers.get("Location"), f);
      }
      if (_ === "async")
        return m;
      const { writable: $, readable: P } = new TransformStream();
      return m.pipeTo($), P;
    });
  } });
}
function C(e, n) {
  return () => {
    if (e.response && e.response.headers.get("Location")) {
      const t = b(e.response);
      L$1(n, t), pt(n, "Location", e.response.headers.get("Location"));
    }
  };
}
function k(e) {
...
var ze = ['<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="icon" href="/favicon.ico">', "</head>"], Ge = ["<html", ' lang="en">', '<body><div id="app">', "</div><!--$-->", "<!--/--></body></html>"];
const tt = De(() => createComponent$1(xe, { document: ({ assets: e, children: n, scripts: t }) => ssr(Ge, ssrHydrationKey(), createComponent$1(NoHydration, { get children() {
  return ssr(ze, escape(e));
} }), escape(n), escape(t)) }));

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/_server', handler: Le$2, lazy: false, middleware: true, method: undefined },
...
export { Rt$1 as R, St as S, mt as a, wt as b, Rt as c, nodeServer as d, mt$1 as m, node$1 as n, wt$1 as w, yt$1 as y };
