        ...
        <div class="loginFormContainer">
            <form class="loginBox">
                ...
                <button class="google-button" type="button">
                    <img src={googleLogo} class="google-logo" alt={"google-logo"}/>
